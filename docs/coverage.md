...
| fixed | `fixed-float-width-conversions` | 3 | semantic | Independent conversion expectations do not directly exercise Backends.Scalar for every overload. | Add direct root, Backends.Scalar, and Backends.Native assertions to each independent conversion oracle. |
| fixed | `fixed-signedness-conversions` | 8 | semantic | Independent conversion expectations do not directly exercise Backends.Scalar for every overload. | Add direct root, Backends.Scalar, and Backends.Native assertions to each independent conversion oracle. |
...
| fixed | `fixed-numeric-conversions` | 8 | semantic | Independent conversion expectations do not directly exercise Backends.Scalar for every overload. | Add direct root, Backends.Scalar, and Backends.Native assertions to each independent conversion oracle. |
...
| fixed | `fixed-float-width-conversions` | 3 | gap | complete | complete | complete |
| fixed | `fixed-signedness-conversions` | 8 | gap | gap | gap | complete |
| fixed | `fixed-numeric-conversions` | 8 | gap | complete | complete | complete |
