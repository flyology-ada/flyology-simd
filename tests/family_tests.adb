...
procedure Family_Tests is
      ...
      for Iteration in 1 .. 250 loop
         ...
         begin
            ...
            for Lane in Lane_Index_8x16 loop
               ...
               Check (Extract (Multiply_Wrap (R_A, R_B), Lane) = Bits_To_I8x16 (I8x16_To_Bits (Extract (R_A, Lane)) * I8x16_To_Bits (Extract (R_B, Lane))) and then Backends.Native.Extract (Backends.Native.Multiply_Wrap (R_A, R_B), Lane) = Bits_To_I8x16 (I8x16_To_Bits (Extract (R_A, Lane)) * I8x16_To_Bits (Extract (R_B, Lane))), "I8x16 independent scalar and native multiply oracle" & Lane'Image);
      ...
      for Iteration in 1 .. 250 loop
         ...
         begin
            ...
            for Lane in Lane_Index_16x8 loop
               ...
               Check (Extract (Multiply_Wrap (R_A, R_B), Lane) = Extract (R_A, Lane) * Extract (R_B, Lane) and then Backends.Native.Extract (Backends.Native.Multiply_Wrap (R_A, R_B), Lane) = Extract (R_A, Lane) * Extract (R_B, Lane), "U16x8 independent scalar and native multiply oracle" & Lane'Image);
      ...
      for Iteration in 1 .. 250 loop
         ...
         begin
            ...
            for Lane in Lane_Index_16x8 loop
               ...
               Check (Extract (Multiply_Wrap (R_A, R_B), Lane) = Bits_To_I16x8 (I16x8_To_Bits (Extract (R_A, Lane)) * I16x8_To_Bits (Extract (R_B, Lane))) and then Backends.Native.Extract (Backends.Native.Multiply_Wrap (R_A, R_B), Lane) = Bits_To_I16x8 (I16x8_To_Bits (Extract (R_A, Lane)) * I16x8_To_Bits (Extract (R_B, Lane))), "I16x8 independent scalar and native multiply oracle" & Lane'Image);
      ...
      for Iteration in 1 .. 250 loop
         ...
         begin
            ...
            for Lane in Lane_Index_32x4 loop
               ...
               Check (Extract (Multiply_Wrap (R_A, R_B), Lane) = Extract (R_A, Lane) * Extract (R_B, Lane) and then Backends.Native.Extract (Backends.Native.Multiply_Wrap (R_A, R_B), Lane) = Extract (R_A, Lane) * Extract (R_B, Lane), "U32x4 independent scalar and native multiply oracle" & Lane'Image);
      ...
      for Iteration in 1 .. 250 loop
         ...
         begin
            ...
            for Lane in Lane_Index_32x4 loop
               ...
               Check (Extract (Multiply_Wrap (R_A, R_B), Lane) = Bits_To_I32x4 (I32x4_To_Bits (Extract (R_A, Lane)) * I32x4_To_Bits (Extract (R_B, Lane))) and then Backends.Native.Extract (Backends.Native.Multiply_Wrap (R_A, R_B), Lane) = Bits_To_I32x4 (I32x4_To_Bits (Extract (R_A, Lane)) * I32x4_To_Bits (Extract (R_B, Lane))), "I32x4 independent scalar and native multiply oracle" & Lane'Image);
      ...
      for Iteration in 1 .. 250 loop
         ...
         begin
            ...
            for Lane in Lane_Index_64x2 loop
               ...
               Check (Extract (Multiply_Wrap (R_A, R_B), Lane) = Extract (R_A, Lane) * Extract (R_B, Lane) and then Backends.Native.Extract (Backends.Native.Multiply_Wrap (R_A, R_B), Lane) = Extract (R_A, Lane) * Extract (R_B, Lane), "U64x2 independent scalar and native multiply oracle" & Lane'Image);
      ...
      for Iteration in 1 .. 250 loop
         ...
         begin
            ...
            for Lane in Lane_Index_64x2 loop
               ...
               Check (Extract (Multiply_Wrap (R_A, R_B), Lane) = Bits_To_I64x2 (I64x2_To_Bits (Extract (R_A, Lane)) * I64x2_To_Bits (Extract (R_B, Lane))) and then Backends.Native.Extract (Backends.Native.Multiply_Wrap (R_A, R_B), Lane) = Bits_To_I64x2 (I64x2_To_Bits (Extract (R_A, Lane)) * I64x2_To_Bits (Extract (R_B, Lane))), "I64x2 independent scalar and native multiply oracle" & Lane'Image);
   ...
   begin
      ...
      for Pattern in Natural range 0 .. 2 ** 4 - 1 loop
         ...
         for Lane in Lane_Index_32x4 loop Check (Bits_F32x4 (Extract (Select_Value (Mask_From_Bit_Mask (Interfaces.Unsigned_8 (Pattern)), A, B), Lane)) = Bits_F32x4 ((if (Pattern / 2 ** Lane) mod 2 = 1 then Extract (A, Lane) else Extract (B, Lane))) and then Bits_F32x4 (Backends.Native.Extract (Backends.Native.Select_Value (Backends.Native.Mask_From_Bit_Mask (Interfaces.Unsigned_8 (Pattern)), A, B), Lane)) = Bits_F32x4 ((if (Pattern / 2 ** Lane) mod 2 = 1 then Extract (A, Lane) else Extract (B, Lane))), "F32x4 independent bitwise scalar and native select" & Pattern'Image & Lane'Image); end loop;
      end loop;
