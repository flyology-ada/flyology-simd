...
def program() -> str:
    ...
    out += [
        ...
        "      I64_Input : constant F64x2 := From_Lanes ([1.75, -1.75]);",
        "      U64_Input : constant F64x2 := From_Lanes",
        "        ([F64_Of_Bits (16#43E0_0000_0000_0000#),",
        "          F64_Of_Bits (16#43EF_FFFF_FFFF_FFFF#)]);",
        "      Expected_I64 : constant Lane_Values_I64x2 := [1, -1];",
        "      Expected_U64 : constant Lane_Values_U64x2 :=",
        "        [9_223_372_036_854_775_808, 18_446_744_073_709_549_568];",
        "",
        ...
        "         Scalar_I64 := Convert_Truncate_Saturate (I64_Input);",
        "         Native_I64 := Backends.Native.Convert_Truncate_Saturate (I64_Input);",
        "         Scalar_U64 := Convert_Truncate_Saturate (U64_Input);",
        "         Native_U64 := Backends.Native.Convert_Truncate_Saturate (U64_Input);",
        "         for Lane in Lane_Index_32x4 loop",
        ...
        "         end loop;",
        "         for Lane in Lane_Index_64x2 loop",
        "            Check (Extract (Scalar_I64, Lane) = Expected_I64 (Lane),",
        "                   \"scalar F64 to I64 rounding-mode independence\");",
        "            Check (Extract (Native_I64, Lane) = Expected_I64 (Lane),",
        "                   \"native F64 to I64 rounding-mode independence\");",
        "            Check (Extract (Scalar_U64, Lane) = Expected_U64 (Lane),",
        "                   \"scalar F64 to U64 rounding-mode independence\");",
        "            Check (Extract (Native_U64, Lane) = Expected_U64 (Lane),",
        "                   \"native F64 to U64 rounding-mode independence\");",
        "         end loop;",
        "         Check ((Current and Rounding_Mask) = Mode_Bits (Mode),",
