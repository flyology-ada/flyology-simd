#!/usr/bin/env python3
"""Generate exact public callers for all Wide saturating arithmetic overloads."""
...
SPEC = PROBES / "wide_saturating_arithmetic_codegen_probe.ads"
BODY = PROBES / "wide_saturating_arithmetic_codegen_probe.adb"
CASES = PROBES / "wide_saturating_arithmetic_codegen_cases.txt"
...
def spec_text() -> str:
    ...
    lines.extend(["end Wide_Saturating_Arithmetic_Codegen_Probe;", ""])
    return "\n".join(lines)
