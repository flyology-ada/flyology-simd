...
def invalid_support(path: Path) -> list[str]:
    ...
    if path.name == "flyology_simd-wide-native.ads":
        required = {
            ...
            "function Interleave_Low": "same portable Ada implementation",
            "function Interleave_High": "same portable Ada implementation",
            "function Deinterleave_Even": "same portable Ada implementation",
            "function Deinterleave_Odd": "same portable Ada implementation",
            "function Slide_Lanes_Toward_Low": "same portable Ada implementation",
            "function Slide_Lanes_Toward_High": "same portable Ada implementation",
