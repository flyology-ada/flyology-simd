#!/usr/bin/env python3
"""Generate exact callers for all fixed-width wrapping arithmetic overloads."""
...
SPEC = PROBES / "wrapping_arithmetic_codegen_probe.ads"
BODY = PROBES / "wrapping_arithmetic_codegen_probe.adb"
CASES = PROBES / "wrapping_arithmetic_codegen_cases.txt"
...
def spec_text() -> str:
    lines = ["with Flyology_SIMD;", "", "package Wrapping_Arithmetic_Codegen_Probe is"]
    ...
    return "\n".join((*lines, "end Wrapping_Arithmetic_Codegen_Probe;", ""))
