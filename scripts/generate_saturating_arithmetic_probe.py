#!/usr/bin/env python3
"""Generate exact callers for all fixed-width saturating arithmetic overloads."""
...
SPEC = PROBES / "saturating_arithmetic_codegen_probe.ads"
BODY = PROBES / "saturating_arithmetic_codegen_probe.adb"
CASES = PROBES / "saturating_arithmetic_codegen_cases.txt"
...
OPERATIONS = ("add_saturate", "subtract_saturate")
...
def spec_text() -> str:
    lines = ["with Flyology_SIMD;", "", "package Saturating_Arithmetic_Codegen_Probe is"]
    ...
    return "\n".join((*lines, "end Saturating_Arithmetic_Codegen_Probe;", ""))
