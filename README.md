...
stable mask compression and expansion. `Sum` and `Dot_Product` provide
runtime-dispatched binary32 and binary64 complete-array algorithms.
...
- `Algorithms.Generic_Floating` provides the same static composition boundary
  for binary32 and binary64 sums and dot products. The supplied
