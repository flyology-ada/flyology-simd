...
narrowing. General numeric conversions, arbitrary lane-index shuffles, and
256-bit types are not implemented. See the [operation matrix](https://simd.flyology.org/guide/operations/)
