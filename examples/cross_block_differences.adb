...
procedure Cross_Block_Differences is
   ...
   Successor_Map   : constant Wide.Two_Source_Lane_Map_32x8 :=
     Wide.Make_Two_Source_Lane_Map
       ([Wide.Select_Left_Lane (1),
         Wide.Select_Left_Lane (2),
         Wide.Select_Left_Lane (3),
         Wide.Select_Left_Lane (4),
         Wide.Select_Left_Lane (5),
         Wide.Select_Left_Lane (6),
         Wide.Select_Left_Lane (7),
         Wide.Select_Right_Lane (0)]);
   Left            : constant Wide.F32x8 := Native.From_Lanes ([1.0, 4.0, 9.0, 16.0, 25.0, 36.0, 49.0, 64.0]);
   Right           : constant Wide.F32x8 :=
     Native.From_Lanes ([81.0, 100.0, 121.0, 144.0, 169.0, 196.0, 225.0, 256.0]);
   Successors      : constant Wide.F32x8 := Native.Permute_Lanes (Left, Right, Successor_Map);
   Differences     : constant Wide.F32x8 := Native.Subtract (Successors, Left);
   Successor_Lanes : constant Wide.Lane_Values_F32x8 := Native.To_Lanes (Successors);
   Result          : constant Wide.Lane_Values_F32x8 := Native.To_Lanes (Differences);

   procedure Put_Vector (Label_Text : String; Values : Wide.Lane_Values_F32x8) is
   begin
      Put_Line (Label_Text);
...
begin
   pragma Assert (Successor_Lanes = [4.0, 9.0, 16.0, 25.0, 36.0, 49.0, 64.0, 81.0]);
