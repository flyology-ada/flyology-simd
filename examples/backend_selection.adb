...
procedure Backend_Selection is
   ...
   Best          : constant Flyology_SIMD.Features.Backend_Kind := Flyology_SIMD.Features.Best_Available;
   Static_Count  : constant Natural := Flyology_SIMD.Algorithms.Native.Count (Data, Needle);
   Runtime_Count : constant Natural := Flyology_SIMD.Algorithms.Runtime.Count (Data, Needle);
   Forced_Count  : constant Natural := Flyology_SIMD.Algorithms.Runtime.Count (Data, Needle, Backend => Best);
begin
