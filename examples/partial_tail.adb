...
begin
   while Start <= Data'Last loop
      declare
         ...
         Value     : constant U8x16 := Native.Load_Partial (Data, Start, Count);
         Result    : constant U8x16 := Native.Add_Saturate (Value, Native.Splat (10));
      begin
   ...
   Put_Line ("first=" & U8'Image (Data (Data'First)) & ", last=" & U8'Image (Data (Data'Last)));
end Partial_Tail;
