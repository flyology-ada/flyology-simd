...
package Flyology_SIMD.Algorithms.Scalar_Floating is new
  Flyology_SIMD.Algorithms.Generic_Floating
    (Backend_F32_Zero              => Flyology_SIMD.Backends.Scalar.Zero,
     ...
     Backend_F32_Reduce_Min_Number => Flyology_SIMD.Backends.Scalar.Reduce_Min_Number,
     Backend_F32_Reduce_Max_Number => Flyology_SIMD.Backends.Scalar.Reduce_Max_Number,
